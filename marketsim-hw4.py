...
Modified on January, 13, 2016

@author: Finnishmiko
@contact: finnishmiko@hotmail.com
@summary: Homework 3 for Computational investing course
'''
...
def reference(dt_start, dt_end, ls_symbols):
    ...
    #it seems that in 2010 there are different amount of trading days
    #than 252, so that need to be set manually as said in assignment
    ...
    plt.legend(["portfolio","$SPX"])#ls_symbols)
...
def main():
    ...
    orders = "ordersBelow10.csv" # for homework4
    #orders = "orders02quiz.csv" # for Homework3 
    #orders = "orders.csv" # Here is problems
