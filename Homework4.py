'''
Homework 4 for Coursera Computational investing course
wiki.quantsoftware.org

Modify homework 2 event profiler to output results to an orders.csv
file that can be tested with homework 3 market simulator.
'''
